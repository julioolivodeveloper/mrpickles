...
const SANDWICHES: MenuItem[] = [
  { id:1,  name:'Meatball',        desc:'Meatballs, marinara sauce and pepper jack cheese',                                               price:16.5, toasted:true, image:'https://img.cdn4dd.com/p/fit=cover,width=1200,height=1200,format=auto,quality=90/media/photos/e3b30d7e-dabc-42f6-9e1c-295660c729e8-retina-large-jpeg' },
  { id:2,  name:'Vegi',            desc:'Choice of cheese, avocado, sprouts, cucumber',                                                   price:13.5, veg:true,     image:'https://img.cdn4dd.com/p/fit=cover,width=1200,height=1200,format=auto,quality=90/media/photos/55a7ecbd-1923-4ac4-8dfa-63e19ff3deb9-retina-large-jpeg' },
  { id:3,  name:'Tony Soprano',    desc:'Salami, ham, mortadella, provolone cheese & Italian dressing',                                   price:16.5,               image:'https://img.cdn4dd.com/p/fit=cover,width=1200,height=1200,format=auto,quality=90/media/photos/a59069f9-5a86-4c6e-87bb-14379c4d2da8-retina-large-jpeg' },
  { id:4,  name:'Tom Tom',         desc:'Turkey, bacon and swiss cheese',                                                                  price:16.5,               image:'https://img.cdn4dd.com/p/fit=cover,width=1200,height=1200,format=auto,quality=90/media/photos/a84803bc-8982-44ea-9fb5-0543d5663773-retina-large-jpeg' },
  { id:5,  name:'Diyana',          desc:'Pastrami, swiss and thousand island on rye',                                                      price:16,   toasted:true, image:'https://img.cdn4dd.com/p/fit=cover,width=1200,height=1200,format=auto,quality=90/media/yelp/068c04b2-d2c4-4e3b-87b3-f0daee082361.jpg' },
  ...
  { id:31, name:'Peak Special',    desc:'Pastrami, bacon, avocado with cream cheese',                                                      price:17,                 image:'https://img.cdn4dd.com/p/fit=cover,width=1200,height=1200,format=auto,quality=90/media/yelp/93fc0f1e-e2bd-44e7-a0f2-9ba757875247.jpg' },
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          ...
          <Image src="/pepe.png" alt="Delicious sandwiches" fill className="md:hidden object-cover object-center" priority />
      ...
      <div className="relative py-10 px-4 overflow-hidden">
        <Image src="/fanfavorites.avif" alt="Fan Favorites background" fill className="object-cover object-[center_30%] md:object-[center_20%]" />
